    ...
    <>
      ...
      <main id="main">
        <section class="wellcome">
          <div class="container">
            <h2 class="wellcome__heading">
              Хранители
              <br />
              Наследия
            </h2>
            <div class="wellcome__links">
        ...
        <div class="footer__desc">
          <div class="container footer__descr-container">
            ...
            <div class="footer__social">
              ...
              <ul>
                <li>
                  <img src="../public/img/icon-tw.svg" alt="Twitter" />
                  <a href="#!">Twitter</a>
                </li>
                <li>
                ...
                <li>
                  <img src="../public/img/icon-gl.svg" alt="google" />
                  <a href="#!">Google</a>
                </li>
                <li>
                  <img src="../public/img/icon-wb.svg" alt="webflow" />
                  <a href="#!">Webflow</a>
                </li>
              </ul>
            </div>
